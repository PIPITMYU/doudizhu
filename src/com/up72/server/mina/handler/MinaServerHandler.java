            ...
            try{
            	...
            	if (userId!=null && cid != null) {
                	...
                	if(playerByUserId != null && playerByUserId.getRoomId() != null)
                	{
                		...
                		{
//                			List<Player> playerList = RedisUtil.getPlayerList(roomRespByRoomId);
                			MessageFunctions.interface_100109(RedisUtil.getPlayerList(roomRespByRoomId.getRoomId(),cid),
        							Cnst.PLAYER_LINE_STATE_OUT,
        							playerByUserId.getUserId(),
        							playerByUserId.getPlayStatus());
                		}
                	}
...
//                System.out.println("信息已经传送给到达客户端void messageSent........");
    ...
    public void sessionClosed(IoSession session) throws Exception {
    	logger.I("链接关闭，id为"+session.getId());
       // 当一个客户端关闭时
    ...
    public void sessionCreated(IoSession session) throws Exception {
    	logger.I("新客户端连接,id="+session.getId());//0314 当一个新客户端连接后触发此方法.
    ...
    public void sessionOpened(IoSession session) throws Exception {
        ...
        //当一个客端端连接进入时
        count++;
        logger.I("第 " + count + " 个 client 登陆！address： : "
