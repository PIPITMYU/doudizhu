...
public class JieSuan {
	...
	public static void xiaoJieSuan(RoomResp room,String cid) {
		...
		
		{
			...
			//map.put("score", arrayList1);
			map.put("score", room.getXiaoJieSuanScore());
			//map.put("score",room.getScore());//每小局总和的总分.
...
//			List<List<Long>> xiaoJuFen = room.getXiaoJuFen();
//			for (List<Long> list : xiaoJuFen) {
//				for (int i = 0; i < list.size()-1; i++) {
//					countScore.set(i, list.get(i));
//				}
//			}
